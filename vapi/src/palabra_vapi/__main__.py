"""Console entrypoint: ``palabra-vapi-bridge [--host 0.0.0.0] [--port 8080]``."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description='Vapi <-> Palabra Realtime STT/TTS bridge')
    ...
    uvicorn.run('palabra_vapi.app:app', host=args.host, port=args.port, log_level=level.lower())
